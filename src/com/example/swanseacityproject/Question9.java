...
public class Question9 extends Activity {
	...
	protected void onCreate (Bundle savedInstantState){
		...
		setContentView(R.layout.question9_activity);
		buttonClick();
		
	}
	public void buttonClick(){
		scored = (TextView)findViewById(R.id.scoreQ9);
		answer = (TextView)findViewById(R.id.answer9);
		
		final SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
		
        ansOne = (Button)findViewById(R.id.button_q9a1);
        ansOne.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (ansOne.getText() == questionAnswer){
					...
					Question9.this.startActivity(Intent);
					ansOne.setBackgroundColor(Color.GREEN);
					editor.putInt("answer_value9", 1);					

				}else{
					Intent Intent = new Intent(Question9.this, Question10.class);
					Question9.this.startActivity(Intent);
					ansOne.setBackgroundColor(Color.RED);
					editor.putInt("answer_value9", 0);					
        ...
        ansTwo = (Button)findViewById(R.id.button_q9a2);
        ...
        ansThree = (Button)findViewById(R.id.button_q9a3);
