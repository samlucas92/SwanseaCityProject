...
public class Question10 extends Activity {
	...
	protected void onCreate (Bundle savedInstantState){
		...
		setContentView(R.layout.question10_activity);
		buttonClick();
	}
	public void buttonClick(){
		scored = (TextView)findViewById(R.id.scoreQ10);
		answer = (TextView)findViewById(R.id.answer10);
		
		final SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
		
        ansOne = (Button)findViewById(R.id.button_q10a1);
        ansOne.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (ansOne.getText() == questionAnswer){
					Intent Intent = new Intent(Question10.this, QuizResult.class);
					Question10.this.startActivity(Intent);
					ansOne.setBackgroundColor(Color.GREEN);
					editor.putInt("answer_value10", 1);					

				}else{
					Intent Intent = new Intent(Question10.this, QuizResult.class);
					Question10.this.startActivity(Intent);
					ansOne.setBackgroundColor(Color.RED);
					editor.putInt("answer_value10", 0);					
        ...
        ansTwo = (Button)findViewById(R.id.button_q10a2);
        ...
        ansThree = (Button)findViewById(R.id.button_q10a3);
